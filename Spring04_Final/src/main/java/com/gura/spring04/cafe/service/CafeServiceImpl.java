...
public class CafeServiceImpl implements CafeService{
	...
	@Override
	public void getList(HttpServletRequest requset) {
	      //한 페이지에 몇개씩 표시할 것인지
	      ...
	      String strPageNum=requset.getParameter("pageNum");
	      ...
	      */
	      ...
	      String condition=requset.getParameter("condition");
	      //만일 키워드가 넘어오지 않는다면 
	      if(keyword==null){
	      ...
	      requset.setAttribute("startPageNum", startPageNum);
	      requset.setAttribute("endPageNum", endPageNum);
	      requset.setAttribute("condition", condition);
	      requset.setAttribute("keyword", keyword);
	      requset.setAttribute("encodedK", encodedK);
	      requset.setAttribute("totalPageCount", totalPageCount);
	      requset.setAttribute("list", list);
	      requset.setAttribute("totalRow", totalRow);
	}

	@Override
	public void getDetall(HttpServletRequest requset) {
	      //자세히 보여줄 글번호를 읽어온다. 
	      ...
	      */
	      ...
	      requset.setAttribute("dto", resultDto);
	      requset.setAttribute("condition", condition);
	      requset.setAttribute("keyword", keyword);
	      requset.setAttribute("encodedK", encodedK);
	      requset.setAttribute("totalRow", totalRow);
	      requset.setAttribute("commentList", commentList);
	      requset.setAttribute("totalPageCount", totalPageCount);
	...
	public void saveContent(CafeDto dto) {
		//title, content, writer 정보가 들어 있는 CafeDto를 dao에 전달해서 DB에 저장되도록한다.
		cafeDao.insert(dto);
	}
	...
	@Override
	public void deleteContent(int num, HttpServletRequest requset) {
		//세션에서 로그인된 아이디를 읽어와서
	...
	//글수정 폼에 필요한값을 HttpServletRequest 에 담아주는 메소드
	@Override
	public void getData(HttpServletRequest requset) {
		//수정할 글번호
		int num = Integer.parseInt(requset.getParameter("num"));
		//수정할 글의 정보 얻어와서
		CafeDto dto = cafeDao.getData(num);
	...
	public void deleteComment(HttpServletRequest request) {
		...
		if(!dto.getWriter().equals(id)) {
			throw new NotDeleteException("삭제된 댓글입니다");
		}
