...
<body>
   <div class="container animate__animated animate__rotateIn" >
      ...
      <h3>글 상세 보기</h3>
      <table class="table table-bordered animate__animated animate__heartBeat">
         <tr>
            <th>글번호</th>
            <td>${dto.num }</td>
         </tr>
   ...
   <script>
      ...
      /*
	        detail
		        ...
		        댓글에 이벤트 리스너 등록 하기 
	      	미리 만들어진 함수를 호출하면서 이벤트 리스너를 등록
	      	페이지로딩시점에 1페이지의댓글은 이미 축력이되어있기떄문에 아래처럼
	      	선택자만 등록을해서 등록을하면된다 
	      	추가를하게되먄 이미있는애들고 추가한 애들만 이벤트리스너등록할필요가있다
      */
         ...
         for(let i=0; i<replyLinks.length; i++){
            replyLinks[i].addEventListener("click", function(){
               ...
               if(current == "답글"){
                  ...
                  form.classList.add("animate__heartBeat");
                  this.innerText="취소";   
                  form.addEventListener("animationend", function(){
                     form.classList.remove("animate__heartBeat");
                  }, {once:true});
               }else if(current == "취소"){
